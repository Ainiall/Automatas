...
NUMBER=({REAL}|{INTEGER}) //con y sin punto
POINT2D=({NUMBER}{BLANK}{NUMBER}) 
POINT3D=({NUMBER}{BLANK}{NUMBER}{BLANK}{NUMBER})
...
{POINT}      {System.out.println("SCANNER:: found POINT <"+ yytext() +">");}
{POLYLINE}   {System.out.println("SCANNER:: found POLYLINE <"+ yytext() +">");}
